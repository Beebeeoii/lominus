...
// HTTP request used for retrieving folders in a module's uploaded files on Canvas.
...
// HTTP request used for retrieving files in a module's uploaded files on Canvas.
